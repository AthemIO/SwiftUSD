...
let package = Package(
    ...
    targets: [
        ...
        .target(
            ...
            exclude: [
                "tsTest_AnimXEvaluator.cpp",  // Requires external AnimX library
            ],
            cxxSettings: [
        ...
        .target(
            ...
            exclude: [
                // Temporarily exclude USDZ support due to namespace resolution issues
                "usdzFileFormat.cpp",
                "usdzResolver.cpp",
        ...
        .target(
            ...
            exclude: [
                // Exclude Python bindings (Python support disabled)
                "pyUtils.cpp",
