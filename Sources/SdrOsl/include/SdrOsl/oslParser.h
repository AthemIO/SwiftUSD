...
class SdrOslParserPlugin : public SdrParserPlugin {
 public:
  ...
  SDROSL_API
  SdrShaderNodeUniquePtr Parse(const SdrShaderNodeDiscoveryResult &discoveryResult) override;
 ...
 private:
  ...
  // query object
  SdrTokenMap _getNodeMetadata(const OSL::OSLQuery &query, const SdrTokenMap &baseMetadata) const;
  ...
  void _injectParserMetadata(SdrTokenMap &metadata, const TfToken &typeName) const;
