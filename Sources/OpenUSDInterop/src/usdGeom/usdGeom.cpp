...
// ============================================================================
// MARK: - Stub Implementations for Remaining Functions
// ============================================================================

// UsdGeomPoints stubs
UsdGeomPointsRef UsdGeomPoints_Define(UsdStageRef stage, SdfPathRef path) { return nullptr; }
UsdGeomPointsRef UsdGeomPoints_FromPrim(UsdPrimRef prim) { return nullptr; }
UsdGeomPointsRef UsdGeomPoints_Retain(UsdGeomPointsRef points) { return nullptr; }
void UsdGeomPoints_Release(UsdGeomPointsRef points) {}
bool UsdGeomPoints_IsValid(UsdGeomPointsRef points) { return false; }
UsdPrimRef UsdGeomPoints_GetPrim(UsdGeomPointsRef points) { return nullptr; }
size_t UsdGeomPoints_GetPointCount(UsdGeomPointsRef points, UsdTimeCode time) { return 0; }
size_t UsdGeomPoints_GetPoints(UsdGeomPointsRef points, UsdTimeCode time, float* outPoints, size_t maxCount) { return 0; }
UsdResult UsdGeomPoints_SetPoints(UsdGeomPointsRef points, UsdTimeCode time, const float* pointsData, size_t count) { return USD_RESULT_ERROR; }
size_t UsdGeomPoints_GetWidthsCount(UsdGeomPointsRef points, UsdTimeCode time) { return 0; }
size_t UsdGeomPoints_GetWidths(UsdGeomPointsRef points, UsdTimeCode time, float* outWidths, size_t maxCount) { return 0; }
UsdResult UsdGeomPoints_SetWidths(UsdGeomPointsRef points, UsdTimeCode time, const float* widths, size_t count) { return USD_RESULT_ERROR; }
size_t UsdGeomPoints_GetIdsCount(UsdGeomPointsRef points, UsdTimeCode time) { return 0; }
size_t UsdGeomPoints_GetIds(UsdGeomPointsRef points, UsdTimeCode time, int64_t* outIds, size_t maxCount) { return 0; }
UsdResult UsdGeomPoints_SetIds(UsdGeomPointsRef points, UsdTimeCode time, const int64_t* ids, size_t count) { return USD_RESULT_ERROR; }

// UsdGeomBasisCurves stubs
UsdGeomBasisCurvesRef UsdGeomBasisCurves_Define(UsdStageRef stage, SdfPathRef path) { return nullptr; }
UsdGeomBasisCurvesRef UsdGeomBasisCurves_FromPrim(UsdPrimRef prim) { return nullptr; }
UsdGeomBasisCurvesRef UsdGeomBasisCurves_Retain(UsdGeomBasisCurvesRef curves) { return nullptr; }
void UsdGeomBasisCurves_Release(UsdGeomBasisCurvesRef curves) {}
bool UsdGeomBasisCurves_IsValid(UsdGeomBasisCurvesRef curves) { return false; }
UsdPrimRef UsdGeomBasisCurves_GetPrim(UsdGeomBasisCurvesRef curves) { return nullptr; }
UsdGeomCurveType UsdGeomBasisCurves_GetType(UsdGeomBasisCurvesRef curves) { return USDGEOM_CURVE_TYPE_LINEAR; }
UsdResult UsdGeomBasisCurves_SetType(UsdGeomBasisCurvesRef curves, UsdGeomCurveType type) { return USD_RESULT_ERROR; }
UsdGeomBasis UsdGeomBasisCurves_GetBasis(UsdGeomBasisCurvesRef curves) { return USDGEOM_BASIS_BEZIER; }
UsdResult UsdGeomBasisCurves_SetBasis(UsdGeomBasisCurvesRef curves, UsdGeomBasis basis) { return USD_RESULT_ERROR; }
UsdGeomWrap UsdGeomBasisCurves_GetWrap(UsdGeomBasisCurvesRef curves) { return USDGEOM_WRAP_NONPERIODIC; }
UsdResult UsdGeomBasisCurves_SetWrap(UsdGeomBasisCurvesRef curves, UsdGeomWrap wrap) { return USD_RESULT_ERROR; }
size_t UsdGeomBasisCurves_GetCurveVertexCountsCount(UsdGeomBasisCurvesRef curves, UsdTimeCode time) { return 0; }
size_t UsdGeomBasisCurves_GetCurveVertexCounts(UsdGeomBasisCurvesRef curves, UsdTimeCode time, int* outCounts, size_t maxCount) { return 0; }
UsdResult UsdGeomBasisCurves_SetCurveVertexCounts(UsdGeomBasisCurvesRef curves, UsdTimeCode time, const int* counts, size_t count) { return USD_RESULT_ERROR; }
size_t UsdGeomBasisCurves_GetPointCount(UsdGeomBasisCurvesRef curves, UsdTimeCode time) { return 0; }
size_t UsdGeomBasisCurves_GetPoints(UsdGeomBasisCurvesRef curves, UsdTimeCode time, float* outPoints, size_t maxCount) { return 0; }
UsdResult UsdGeomBasisCurves_SetPoints(UsdGeomBasisCurvesRef curves, UsdTimeCode time, const float* points, size_t count) { return USD_RESULT_ERROR; }
size_t UsdGeomBasisCurves_GetWidthsCount(UsdGeomBasisCurvesRef curves, UsdTimeCode time) { return 0; }
size_t UsdGeomBasisCurves_GetWidths(UsdGeomBasisCurvesRef curves, UsdTimeCode time, float* outWidths, size_t maxCount) { return 0; }
UsdResult UsdGeomBasisCurves_SetWidths(UsdGeomBasisCurvesRef curves, UsdTimeCode time, const float* widths, size_t count) { return USD_RESULT_ERROR; }

// UsdGeomPrimvar stubs
UsdGeomPrimvarRef UsdGeomPrimvar_FromAttribute(UsdAttributeRef attr) { return nullptr; }
UsdGeomPrimvarRef UsdGeomPrimvar_Retain(UsdGeomPrimvarRef primvar) { return nullptr; }
void UsdGeomPrimvar_Release(UsdGeomPrimvarRef primvar) {}
bool UsdGeomPrimvar_IsValid(UsdGeomPrimvarRef primvar) { return false; }
bool UsdGeomPrimvar_HasValue(UsdGeomPrimvarRef primvar) { return false; }
bool UsdGeomPrimvar_HasAuthoredValue(UsdGeomPrimvarRef primvar) { return false; }
TfTokenRef UsdGeomPrimvar_GetName(UsdGeomPrimvarRef primvar) { return nullptr; }
TfTokenRef UsdGeomPrimvar_GetBaseName(UsdGeomPrimvarRef primvar) { return nullptr; }
UsdGeomInterpolation UsdGeomPrimvar_GetInterpolation(UsdGeomPrimvarRef primvar) { return USDGEOM_INTERPOLATION_CONSTANT; }
UsdResult UsdGeomPrimvar_SetInterpolation(UsdGeomPrimvarRef primvar, UsdGeomInterpolation interpolation) { return USD_RESULT_ERROR; }
int UsdGeomPrimvar_GetElementSize(UsdGeomPrimvarRef primvar) { return 1; }
UsdResult UsdGeomPrimvar_SetElementSize(UsdGeomPrimvarRef primvar, int elementSize) { return USD_RESULT_ERROR; }
bool UsdGeomPrimvar_IsIndexed(UsdGeomPrimvarRef primvar) { return false; }
UsdAttributeRef UsdGeomPrimvar_GetAttr(UsdGeomPrimvarRef primvar) { return nullptr; }

// UsdGeomPrimvarsAPI stubs
UsdGeomPrimvarsAPIRef UsdGeomPrimvarsAPI_Get(UsdPrimRef prim) { return nullptr; }
UsdGeomPrimvarsAPIRef UsdGeomPrimvarsAPI_Retain(UsdGeomPrimvarsAPIRef api) { return nullptr; }
void UsdGeomPrimvarsAPI_Release(UsdGeomPrimvarsAPIRef api) {}
bool UsdGeomPrimvarsAPI_IsValid(UsdGeomPrimvarsAPIRef api) { return false; }
UsdGeomPrimvarRef UsdGeomPrimvarsAPI_CreatePrimvar(UsdGeomPrimvarsAPIRef api, TfTokenRef name, TfTokenRef typeName, UsdGeomInterpolation interpolation) { return nullptr; }
UsdGeomPrimvarRef UsdGeomPrimvarsAPI_CreatePrimvarWithElementSize(UsdGeomPrimvarsAPIRef api, TfTokenRef name, TfTokenRef typeName, UsdGeomInterpolation interpolation, int elementSize) { return nullptr; }
UsdGeomPrimvarRef UsdGeomPrimvarsAPI_GetPrimvar(UsdGeomPrimvarsAPIRef api, TfTokenRef name) { return nullptr; }
bool UsdGeomPrimvarsAPI_HasPrimvar(UsdGeomPrimvarsAPIRef api, TfTokenRef name) { return false; }
UsdResult UsdGeomPrimvarsAPI_RemovePrimvar(UsdGeomPrimvarsAPIRef api, TfTokenRef name) { return USD_RESULT_ERROR; }
size_t UsdGeomPrimvarsAPI_GetPrimvarCount(UsdGeomPrimvarsAPIRef api) { return 0; }
size_t UsdGeomPrimvarsAPI_GetPrimvars(UsdGeomPrimvarsAPIRef api, UsdGeomPrimvarRef* outPrimvars, size_t maxCount) { return 0; }

// UsdGeomXformCache stubs
UsdGeomXformCacheRef UsdGeomXformCache_Create(UsdTimeCode time) { return nullptr; }
UsdGeomXformCacheRef UsdGeomXformCache_Retain(UsdGeomXformCacheRef cache) { return nullptr; }
void UsdGeomXformCache_Release(UsdGeomXformCacheRef cache) {}
UsdResult UsdGeomXformCache_GetLocalToWorldTransform(UsdGeomXformCacheRef cache, UsdPrimRef prim, double* outMatrix) { return USD_RESULT_ERROR; }
UsdResult UsdGeomXformCache_GetParentToWorldTransform(UsdGeomXformCacheRef cache, UsdPrimRef prim, double* outMatrix) { return USD_RESULT_ERROR; }
UsdResult UsdGeomXformCache_GetLocalTransformation(UsdGeomXformCacheRef cache, UsdPrimRef prim, double* outMatrix, bool* outResetsXformStack) { return USD_RESULT_ERROR; }
UsdResult UsdGeomXformCache_ComputeRelativeTransform(UsdGeomXformCacheRef cache, UsdPrimRef prim, UsdPrimRef ancestorPrim, double* outMatrix) { return USD_RESULT_ERROR; }
void UsdGeomXformCache_SetTime(UsdGeomXformCacheRef cache, UsdTimeCode time) {}
UsdTimeCode UsdGeomXformCache_GetTime(UsdGeomXformCacheRef cache) { UsdTimeCode tc = {0, true}; return tc; }
void UsdGeomXformCache_Clear(UsdGeomXformCacheRef cache) {}

// UsdGeomBBoxCache stubs
UsdGeomBBoxCacheRef UsdGeomBBoxCache_Create(UsdTimeCode time, const UsdGeomPurpose* purposes, size_t purposeCount, bool useExtentsHint, bool ignoreVisibility) { return nullptr; }
UsdGeomBBoxCacheRef UsdGeomBBoxCache_Retain(UsdGeomBBoxCacheRef cache) { return nullptr; }
void UsdGeomBBoxCache_Release(UsdGeomBBoxCacheRef cache) {}
UsdResult UsdGeomBBoxCache_ComputeWorldBound(UsdGeomBBoxCacheRef cache, UsdPrimRef prim, double* outMin, double* outMax) { return USD_RESULT_ERROR; }
UsdResult UsdGeomBBoxCache_ComputeLocalBound(UsdGeomBBoxCacheRef cache, UsdPrimRef prim, double* outMin, double* outMax) { return USD_RESULT_ERROR; }
UsdResult UsdGeomBBoxCache_ComputeUntransformedBound(UsdGeomBBoxCacheRef cache, UsdPrimRef prim, double* outMin, double* outMax) { return USD_RESULT_ERROR; }
...
UsdTimeCode UsdGeomBBoxCache_GetTime(UsdGeomBBoxCacheRef cache) { UsdTimeCode tc = {0, true}; return tc; }

// Visibility and Purpose stubs
bool UsdGeom_GetVisibility(UsdPrimRef prim, UsdTimeCode time) { return true; }
UsdResult UsdGeom_SetVisibility(UsdPrimRef prim, UsdTimeCode time, bool visible) { return USD_RESULT_ERROR; }
UsdGeomPurpose UsdGeom_GetPurpose(UsdPrimRef prim) { return USDGEOM_PURPOSE_DEFAULT; }
UsdResult UsdGeom_SetPurpose(UsdPrimRef prim, UsdGeomPurpose purpose) { return USD_RESULT_ERROR; }
