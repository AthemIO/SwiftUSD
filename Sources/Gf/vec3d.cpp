...
std::ostream& 
operator<<(std::ostream &out, GfVec3d const &v)
{
    return out << '(' 
...
bool
GfVec3d::operator==(GfVec3f const &other) const
{
...
bool
GfVec3d::operator==(GfVec3h const &other) const
{
    return _data[0] == other[0] &&
           _data[1] == other[1] &&
           _data[2] == other[2];
...
bool
GfVec3d::operator==(GfVec3i const &other) const
{
    return _data[0] == other[0] &&
           _data[1] == other[1] &&
           _data[2] == other[2];
...
void
GfVec3d::BuildOrthonormalFrame(
    GfVec3d *v1, GfVec3d *v2, double eps) const
{
...
GfVec3d
GfSlerp(double alpha, const GfVec3d &v0, const GfVec3d &v1)
{
