...
GfDualQuatd::GfDualQuatd(const GfDualQuatf &other)
    : _real(other.GetReal()) , _dual(other.GetDual())
{
}
GfDualQuatd::GfDualQuatd(const GfDualQuath &other)
    : _real(other.GetReal()) , _dual(other.GetDual())
{
}

std::pair<double, double>
GfDualQuatd::GetLength() const
{
...
GfDualQuatd
GfDualQuatd::GetNormalized(double eps) const
{
    GfDualQuatd dq(*this);
    dq.Normalize(eps);
...
std::pair<double, double>
GfDualQuatd::Normalize(double eps)
{
...
GfDualQuatd::GetInverse() const
{
    ...
    if ( realLengthSqr <= 0.0 )
        return GfDualQuatd::GetIdentity();
    ...
    const GfQuatd dualPart = conjInvLenSqr.GetDual() -
...
void
GfDualQuatd::SetTranslation( const GfVec3d &translation )
{
...
GfVec3d
GfDualQuatd::GetTranslation() const
{
...
GfVec3d
GfDualQuatd::Transform(const GfVec3d &vec) const
{
...
std::ostream &
operator<<(std::ostream &out, const GfDualQuatd &dq)
{
