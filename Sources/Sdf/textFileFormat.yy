...
#define yyscanner context->scanner
  ...
  static bool _SetupValue(const std::string &typeName,
                          Sdf_TextParserContext *context) {
    return context->values.SetupFactory(typeName);
  }

  template <class T>
  static bool _GeneralHasDuplicates(const std::vector<T> &v) {
  ...
  template <class T>
  static inline bool _HasDuplicates(const std::vector<T> &v) {
  ...
  template <class T>
  static void _SetListOpItems(const TfToken &key, SdfListOpType type,
                              const T &itemList,
                              Sdf_TextParserContext *context) {
  ...
  template <class T>
  static void _AppendVectorItem(const TfToken &key, const T &item,
                                Sdf_TextParserContext *context) {
    std::vector<T> vec =
  ...
  template <class T>
  inline static void _SetField(const SdfPath &path, const TfToken &key,
                               const T &item, Sdf_TextParserContext *context) {
    context->data->Set(path, key, VtValue(item));
  }

  inline static bool _HasField(const SdfPath &path, const TfToken &key,
                               VtValue *value, Sdf_TextParserContext *context) {
    return context->data->Has(path, key, value);
  }

  inline static bool _HasSpec(const SdfPath &path,
                              Sdf_TextParserContext *context) {
    return context->data->HasSpec(path);
  }

  inline static void _CreateSpec(const SdfPath &path, SdfSpecType specType,
                                 Sdf_TextParserContext *context) {
    context->data->CreateSpec(path, specType);
  }

  static void _MatchMagicIdentifier(const Value &arg1,
                                    Sdf_TextParserContext *context) {
  ...
  static SdfPermission _GetPermissionFromString(
      const std::string &str, Sdf_TextParserContext *context) {
    if (str == "public") {
  ...
  static TfEnum _GetDisplayUnitFromString(const std::string &name,
                                          Sdf_TextParserContext *context) {
  ...
  static void _ValueAppendAtomic(const Value &arg1,
                                 Sdf_TextParserContext *context) {
  ...
  static void _PrimSetInheritListItems(SdfListOpType opType,
                                       Sdf_TextParserContext * context) {
    ...
    TF_FOR_ALL(path, context->inheritParsingTargetPaths) {
      ERROR_AND_RETURN_IF_NOT_ALLOWED(context,
  ...
  static void _PrimSetSpecializesListItems(SdfListOpType opType,
                                           Sdf_TextParserContext * context) {
  ...
  static void _PrimSetReferenceListItems(SdfListOpType opType,
                                         Sdf_TextParserContext * context) {
  ...
  static void _PrimSetPayloadListItems(SdfListOpType opType,
                                       Sdf_TextParserContext * context) {
    if (context->payloadParsingRefs.empty() &&
        opType != SdfListOpTypeExplicit) {
      Err(context, "Setting payload to None (or an empty list) is only allowed "
    ...
    _SetListOpItems(SdfFieldKeys->Payload, opType, context->payloadParsingRefs,
                    context);
  }

  static void _PrimSetVariantSetNamesListItems(
      SdfListOpType opType, Sdf_TextParserContext * context) {
    std::vector<std::string> names;
    names.reserve(context->nameVector.size());
    TF_FOR_ALL(name, context->nameVector) {
      ERROR_AND_RETURN_IF_NOT_ALLOWED(
          context, SdfSchema::IsValidVariantIdentifier(*name));
    ...
    if (opType == SdfListOpTypeAdded || opType == SdfListOpTypeExplicit) {
      TF_FOR_ALL(i, context->nameVector) {
        _CreateSpec(context->path.AppendVariantSelection(*i, ""),
                    SdfSpecTypeVariantSet, context);
      }

      _SetField(context->path, SdfChildrenKeys->VariantSetChildren,
                context->nameVector, context);
    }
  }

  static void _RelationshipInitTarget(const SdfPath &targetPath,
                                      Sdf_TextParserContext *context) {
  ...
  static void _RelationshipSetTargetsList(SdfListOpType opType,
                                          Sdf_TextParserContext * context) {
    ...
    TF_FOR_ALL(path, *context->relParsingTargetPaths) {
      ERROR_AND_RETURN_IF_NOT_ALLOWED(
          context, SdfSchema::IsValidRelationshipTargetPath(*path));
    }
  ...
  static void _PrimSetVariantSelection(Sdf_TextParserContext * context) {
    ...
    VtValue oldVars;
    if (_HasField(context->path, SdfFieldKeys->VariantSelection, &oldVars,
                  context)) {
    ...
    TF_FOR_ALL(it, context->currentDictionaries[0]) {
      if (!it->second.IsHolding<std::string>()) {
        ...
        ERROR_AND_RETURN_IF_NOT_ALLOWED(
            context, SdfSchema::IsValidVariantSelection(variantName));
  ...
  static void _RelocatesAdd(const Value &arg1, const Value &arg2,
                            Sdf_TextParserContext *context) {
    ...
    context->relocatesParsingMap.insert(
        std::make_pair(srcAbsPath, targetAbsPath));
    context->layerHints.mightHaveRelocates = true;
  }

  static void _AttributeSetConnectionTargetsList(
      SdfListOpType opType, Sdf_TextParserContext * context) {
    ...
    TF_FOR_ALL(path, context->connParsingTargetPaths) {
      ERROR_AND_RETURN_IF_NOT_ALLOWED(
          context, SdfSchema::IsValidAttributeConnectionPath(*path));
    }
    ...
    if (opType == SdfListOpTypeAdded || opType == SdfListOpTypeExplicit) {
      ...
      _SetField(context->path, SdfChildrenKeys->ConnectionChildren,
  ...
  static void _AttributeAppendConnectionPath(Sdf_TextParserContext * context) {
    ...
    if (absPath.ContainsPrimVariantSelection()) {
      TF_WARN("Connection path <%s> (in file @%s@, line %i) has a variant "
              ...
              absPath.GetText(), context->fileContext.c_str(),
              context->sdfLineNo,
  ...
  static void _PrimInitAttribute(const Value &arg1,
                                 Sdf_TextParserContext *context) {
    ...
    if (_HasField(context->path, SdfFieldKeys->TypeName, &oldTypeValue,
                  context)) {
      ...
      if (newType != oldType) {
        Err(context,
            ...
            context->path.GetName().c_str(), oldType.GetText(),
            newType.GetText());
      }
    } else {
    ...
    SdfVariability variability =
        context->variability.IsEmpty()
            ? SdfVariabilityVarying
            : context->variability.Get<SdfVariability>();
    VtValue oldVariability;
    if (_HasField(context->path, SdfFieldKeys->Variability, &oldVariability,
                  context)) {
  ...
  static void _DictionaryInsertValue(const Value &arg1,
                                     Sdf_TextParserContext *context) {
  ...
  static void _DictionaryInsertDictionary(const Value &arg1,
                                          Sdf_TextParserContext *context) {
    size_t n = context->currentDictionaries.size();
  ...
  static void _DictionaryInitScalarFactory(const Value &arg1,
                                           Sdf_TextParserContext *context) {
  ...
  static void _DictionaryInitShapedFactory(const Value &arg1,
                                           Sdf_TextParserContext *context) {
    const std::string typeName = arg1.Get<std::string>() + "[]";
    if (!_SetupValue(typeName, context)) {
      Err(context, "Unrecognized value typename '%s' for dictionary",
  ...
  static void _PrimInitRelationship(const Value &arg1,
                                    Sdf_TextParserContext *context) {
    TfToken name(arg1.Get<std::string>());
    if (!SdfPath::IsValidNamespacedIdentifier(name)) {
    ...
    _SetField(context->path, SdfFieldKeys->Variability, context->variability,
              context);
  ...
  static void _PrimEndRelationship(Sdf_TextParserContext * context) {
    if (!context->relParsingNewTargetChildren.empty()) {
      ...
      _SetField(context->path, SdfChildrenKeys->RelationshipTargetChildren,
                children, context);
    }
  ...
  static void _RelationshipAppendTargetPath(const Value &arg1,
                                            Sdf_TextParserContext *context) {
  ...
  static void _PathSetPrimOrPropertyScenePath(const Value &arg1,
                                              Sdf_TextParserContext *context) {
    const std::string &pathStr = arg1.Get<std::string>();
    context->savedPath = SdfPath(pathStr);
  ...
  static bool _SetItemsIfListOp(const TfType &type,
                                Sdf_TextParserContext *context) {
    ...
    _SetListOpItems(context->genericMetadataKey, context->listOpType, vtArray,
                    context);
    return true;
  }

  static void _SetGenericMetadataListOpItems(const TfType &fieldType,
                                             Sdf_TextParserContext *context) {
  ...
  template <class ListOpType>
  static std::pair<TfType, TfType> _GetListOpAndArrayTfTypes() {
    return {TfType::Find<ListOpType>(),
            TfType::Find<VtArray<typename ListOpType::value_type>>()};
  }

  static bool _IsGenericMetadataListOpType(const TfType &type,
    ...
    auto iter = std::find_if(
        std::begin(listOpAndArrayTypes), std::end(listOpAndArrayTypes),
  ...
  static void _GenericMetadataStart(const Value &name, SdfSpecType specType,
                                    Sdf_TextParserContext *context) {
    ...
    if (specDef.IsMetadataField(context->genericMetadataKey)) {
      ...
      if (_IsGenericMetadataListOpType(fieldType, &itemArrayType)) {
        _SetupValue(schema.FindType(itemArrayType).GetAsToken().GetString(),
                    context);
      } else {
  ...
  static void _GenericMetadataEnd(SdfSpecType specType,
                                  Sdf_TextParserContext * context) {
    const SdfSchema &schema = SdfSchema::GetInstance();
    const SdfSchema::SpecDefinition &specDef =
        *schema.GetSpecDefinition(specType);
    if (specDef.IsMetadataField(context->genericMetadataKey)) {
      ...
      if (context->currentValue.IsHolding<VtDictionary>()) {
        ...
        auto getOldValue = [context]() {
          VtValue v;
          if (_HasField(context->path, context->genericMetadataKey, &v,
                        context) &&
...
%parse-param {Sdf_TextParserContext *context}
            ...
            sdf_file : layer
                           ...
                           keyword : TOK_ABSTRACT |
    TOK_ADD | TOK_APPEND | TOK_CLASS | TOK_CONFIG | TOK_CONNECT | TOK_CUSTOM |
    TOK_CUSTOMDATA | TOK_DEF | TOK_DEFAULT | TOK_DELETE | TOK_DICTIONARY |
    TOK_DISPLAYUNIT | TOK_DOC | TOK_INHERITS | TOK_KIND | TOK_NAMECHILDREN |
    TOK_NONE | TOK_OFFSET | TOK_OVER | TOK_PAYLOAD | TOK_PERMISSION |
    TOK_PREFIX_SUBSTITUTIONS | TOK_SUFFIX_SUBSTITUTIONS | TOK_PREPEND |
    TOK_PROPERTIES | TOK_REFERENCES | TOK_RELOCATES | TOK_REL | TOK_RENAMES |
    TOK_REORDER | TOK_ROOTPRIMS | TOK_SCALE | TOK_SPECIALIZES | TOK_SUBLAYERS |
    TOK_SYMMETRYARGUMENTS | TOK_SYMMETRYFUNCTION | TOK_TIME_SAMPLES |
    TOK_UNIFORM | TOK_VARIANTS | TOK_VARIANTSET | TOK_VARIANTSETS | TOK_VARYING;

//--------------------------------------------------------------------
// Layer Structure
//--------------------------------------------------------------------

layer_metadata_form : layer_metadata_opt |
                      layer_metadata_opt prim_list newlines_opt {

  // Store the names of the root prims.
  _SetField(SdfPath::AbsoluteRootPath(), SdfChildrenKeys->PrimChildren,
...
layer_metadata_opt : newlines_opt {
...
layer_metadata_list_opt : newlines_opt |
                          newlines_opt layer_metadata_list stmtsep_opt;

layer_metadata_list : layer_metadata |
                      layer_metadata_list stmtsep layer_metadata;

layer_metadata_key : identifier;

layer_metadata : TOK_STRING {
  _SetField(context->path, SdfFieldKeys->Comment, $1.Get<std::string>(),
            context);
}
| layer_metadata_key {
  _GenericMetadataStart($1, SdfSpecTypePseudoRoot, context);
}
'=' metadata_value { _GenericMetadataEnd(SdfSpecTypePseudoRoot, context); }
...
// "documentation"
| TOK_DOC '=' TOK_STRING {
  _SetField(context->path, SdfFieldKeys->Documentation, $3.Get<std::string>(),
            context);
}
...
sublayer_list_int : sublayer_stmt | sublayer_list_int listsep sublayer_stmt;

sublayer_stmt : layer_ref layer_offset_opt {
  context->subLayerPaths.push_back(context->layerRefPath);
  context->subLayerOffsets.push_back(context->layerRefOffset);
  ABORT_IF_ERROR(context->seenError);
};

layer_ref : TOK_ASSETREF {
...
layer_offset_int : layer_offset_stmt |
                   layer_offset_int stmtsep layer_offset_stmt;

layer_offset_stmt : TOK_OFFSET '=' TOK_NUMBER {
...
prim_list : prim_stmt | prim_list newlines prim_stmt;
...
prim_stmt_int | TOK_DEF prim_type_name {
  context->specifier = SdfSpecifierDef;
  context->typeName = TfToken($2.Get<std::string>());
}
prim_stmt_int | TOK_CLASS {
  context->specifier = SdfSpecifierClass;
  context->typeName = TfToken();
}
prim_stmt_int | TOK_CLASS prim_type_name {
  context->specifier = SdfSpecifierClass;
  context->typeName = TfToken($2.Get<std::string>());
}
prim_stmt_int | TOK_OVER {
  context->specifier = SdfSpecifierOver;
  context->typeName = TfToken();
}
prim_stmt_int | TOK_OVER prim_type_name {
  context->specifier = SdfSpecifierOver;
  context->typeName = TfToken($2.Get<std::string>());
}
prim_stmt_int | TOK_REORDER TOK_ROOTPRIMS '=' name_list {
  _SetField(context->path, SdfFieldKeys->PrimOrder, context->nameVector,
            context);
  context->nameVector.clear();
};

/* need support for fully qualified python identifiers */
prim_type_name : identifier { $$ = $1; }
| prim_type_name '.' identifier {
  $$ = std::string($1.Get<std::string>() + '.' + $3.Get<std::string>());
};

prim_stmt_int : TOK_STRING {
  ...
  _SetField(context->path, SdfFieldKeys->Specifier, context->specifier,
            context);

  if (!context->typeName.IsEmpty())
    _SetField(context->path, SdfFieldKeys->TypeName, context->typeName,
              context);
}
prim_metadata_opt '{' prim_contents_list_opt '}' {
...
prim_metadata_opt : newlines_opt |
                    newlines_opt '(' prim_metadata_list_opt ')' newlines_opt;

prim_metadata_list_opt : newlines_opt |
                         newlines_opt prim_metadata_list stmtsep_opt;

prim_metadata_list : prim_metadata | prim_metadata_list stmtsep prim_metadata;

prim_metadata_key : identifier | TOK_CUSTOMDATA | TOK_SYMMETRYARGUMENTS;

prim_metadata : TOK_STRING {
  _SetField(context->path, SdfFieldKeys->Comment, $1.Get<std::string>(),
            context);
}
| prim_metadata_key { _GenericMetadataStart($1, SdfSpecTypePrim, context); }
'=' metadata_value { _GenericMetadataEnd(SdfSpecTypePrim, context); }
// Handling for generic metadata fields that use list ops.
// Note that handling of the 'explicit' list op type is done
// in the generic metadata clause above, since there is no
// marker that the parser can use to recognize that case.
...
'=' metadata_listop_list { _GenericMetadataEnd(SdfSpecTypePrim, context); }
| TOK_ADD identifier {
  _GenericMetadataStart($2, SdfSpecTypePrim, context);
  context->listOpType = SdfListOpTypeAdded;
}
...
| TOK_KIND '=' TOK_STRING {
  _SetField(context->path, SdfFieldKeys->Kind, TfToken($3.Get<std::string>()),
            context);
}
...
| TOK_PERMISSION '=' identifier {
  _SetField(context->path, SdfFieldKeys->Permission,
            _GetPermissionFromString($3.Get<std::string>(), context), context);
}
...
'=' payload_list { _PrimSetPayloadListItems(SdfListOpTypeExplicit, context); }
| TOK_DELETE TOK_PAYLOAD {
  context->layerRefPath = std::string();
  context->savedPath = SdfPath();
  context->payloadParsingRefs.clear();
}
'=' payload_list { _PrimSetPayloadListItems(SdfListOpTypeDeleted, context); }
| TOK_ADD TOK_PAYLOAD {
  context->layerRefPath = std::string();
  context->savedPath = SdfPath();
  context->payloadParsingRefs.clear();
}
'=' payload_list { _PrimSetPayloadListItems(SdfListOpTypeAdded, context); }
| TOK_PREPEND TOK_PAYLOAD {
  context->layerRefPath = std::string();
  context->savedPath = SdfPath();
  context->payloadParsingRefs.clear();
}
'=' payload_list { _PrimSetPayloadListItems(SdfListOpTypePrepended, context); }
| TOK_APPEND TOK_PAYLOAD {
  context->layerRefPath = std::string();
  context->savedPath = SdfPath();
  context->payloadParsingRefs.clear();
}
'=' payload_list { _PrimSetPayloadListItems(SdfListOpTypeAppended, context); }
| TOK_REORDER TOK_PAYLOAD {
  context->layerRefPath = std::string();
  context->savedPath = SdfPath();
  context->payloadParsingRefs.clear();
}
'=' payload_list { _PrimSetPayloadListItems(SdfListOpTypeOrdered, context); }
// Not parsed with generic metadata because: SdfListOp is not supported
| TOK_INHERITS { context->inheritParsingTargetPaths.clear(); }
'=' inherit_list { _PrimSetInheritListItems(SdfListOpTypeExplicit, context); }
| TOK_DELETE TOK_INHERITS { context->inheritParsingTargetPaths.clear(); }
'=' inherit_list { _PrimSetInheritListItems(SdfListOpTypeDeleted, context); }
| TOK_ADD TOK_INHERITS { context->inheritParsingTargetPaths.clear(); }
'=' inherit_list { _PrimSetInheritListItems(SdfListOpTypeAdded, context); }
| TOK_PREPEND TOK_INHERITS { context->inheritParsingTargetPaths.clear(); }
'=' inherit_list { _PrimSetInheritListItems(SdfListOpTypePrepended, context); }
| TOK_APPEND TOK_INHERITS { context->inheritParsingTargetPaths.clear(); }
'=' inherit_list { _PrimSetInheritListItems(SdfListOpTypeAppended, context); }
| TOK_REORDER TOK_INHERITS { context->inheritParsingTargetPaths.clear(); }
'=' inherit_list { _PrimSetInheritListItems(SdfListOpTypeOrdered, context); }
// Not parsed with generic metadata because: SdfListOp is not supported
| TOK_SPECIALIZES { context->specializesParsingTargetPaths.clear(); }
'=' specializes_list {
  _PrimSetSpecializesListItems(SdfListOpTypeExplicit, context);
}
| TOK_DELETE TOK_SPECIALIZES { context->specializesParsingTargetPaths.clear(); }
'=' specializes_list {
  _PrimSetSpecializesListItems(SdfListOpTypeDeleted, context);
}
| TOK_ADD TOK_SPECIALIZES { context->specializesParsingTargetPaths.clear(); }
'=' specializes_list {
...
| TOK_APPEND TOK_SPECIALIZES { context->specializesParsingTargetPaths.clear(); }
'=' specializes_list {
...
'=' reference_list { _PrimSetReferenceListItems(SdfListOpTypeAdded, context); }
...
| TOK_VARIANTS '=' typed_dictionary { _PrimSetVariantSelection(context); }
// Not parsed with generic metadata because: SdfListOp is not supported
...
payload_list : TOK_NONE | payload_list_item | '[' newlines_opt ']' |
               '[' newlines_opt payload_list_int listsep_opt ']';

payload_list_int : payload_list_item |
                   payload_list_int listsep payload_list_item;

payload_list_item : layer_ref prim_path_opt payload_params_opt {
...
payload_params_opt :
    /* empty */
    |
    '(' newlines_opt ')' | '(' newlines_opt payload_params_int stmtsep_opt ')';

payload_params_int : payload_params_item |
                     payload_params_int stmtsep payload_params_item;

payload_params_item : layer_offset_stmt;

reference_list : TOK_NONE | reference_list_item | '[' newlines_opt ']' |
                 '[' newlines_opt reference_list_int listsep_opt ']';

reference_list_int : reference_list_item |
                     reference_list_int listsep reference_list_item;

reference_list_item : layer_ref prim_path_opt reference_params_opt {
  if (context->layerRefPath.empty()) {
...
reference_params_int : reference_params_item |
                       reference_params_int stmtsep reference_params_item;

reference_params_item : layer_offset_stmt | TOK_CUSTOMDATA '=' typed_dictionary;

inherit_list : TOK_NONE | inherit_list_item | '[' newlines_opt ']' |
               '[' newlines_opt inherit_list_int listsep_opt ']';

inherit_list_int : inherit_list_item |
                   inherit_list_int listsep inherit_list_item;

inherit_list_item : prim_path { _InheritAppendPath(context); };

specializes_list : TOK_NONE | specializes_list_item | '[' newlines_opt ']' |
                   '[' newlines_opt specializes_list_int listsep_opt ']';

specializes_list_int : specializes_list_item |
                       specializes_list_int listsep specializes_list_item;

specializes_list_item : prim_path { _SpecializesAppendPath(context); };

relocates_map : '{' newlines_opt relocates_stmt_list_opt '}';
...
relocates_stmt_list : relocates_stmt |
                      relocates_stmt_list listsep relocates_stmt;

relocates_stmt : TOK_PATHREF ':' TOK_PATHREF {
  _RelocatesAdd($1, $3, context);
};

name_list : name_list_item | '[' newlines_opt name_list_int listsep_opt ']';

name_list_int : name_list_item | name_list_int listsep name_list_item;

name_list_item : TOK_STRING {
  context->nameVector.push_back(TfToken($1.Get<std::string>()));
};

// Prim Contents

prim_contents_list_opt : newlines_opt | newlines_opt prim_contents_list;
...
prim_contents_list_item
    : prim_property stmtsep{} |
      prim_child_order_stmt stmtsep{} | prim_property_order_stmt stmtsep{} |
      prim_stmt newlines | variantset_stmt newlines;

variantset_stmt : TOK_VARIANTSET TOK_STRING {
...
'=' newlines_opt '{' newlines_opt variant_list '}' {
  ...
  if (!_HasSpec(variantSetPath, context)) {
    ...
    _AppendVectorItem(SdfChildrenKeys->VariantSetChildren,
                      TfToken(context->currentVariantSetNames.back()), context);
  }
...
variant_list : variant_stmt | variant_list variant_stmt;

variant_stmt : TOK_STRING {
  const std::string variantName = $1.Get<std::string>();
  ERROR_IF_NOT_ALLOWED(context,
  ...
  context->path = context->path.GetParentPath().AppendVariantSelection(
      variantSetName, variantName);
...
prim_child_order_stmt : TOK_REORDER TOK_NAMECHILDREN '=' name_list {
  _SetField(context->path, SdfFieldKeys->PrimOrder, context->nameVector,
            context);
  context->nameVector.clear();
};

prim_property_order_stmt : TOK_REORDER TOK_PROPERTIES '=' name_list {
  _SetField(context->path, SdfFieldKeys->PropertyOrder, context->nameVector,
            context);
  context->nameVector.clear();
};
...
prim_property : prim_attribute | prim_relationship;

//--------------------------------------------------------------------
// Attribute Structure
//--------------------------------------------------------------------

prim_attr_variability : TOK_UNIFORM {
...
prim_attr_qualifiers : prim_attr_variability { context->assoc = VtValue(); };

prim_attr_type : identifier { _SetupValue($1.Get<std::string>(), context); }
| identifier '[' ']' {
  _SetupValue(std::string($1.Get<std::string>() + "[]"), context);
};

prim_attribute_full_type : prim_attr_type {
  context->variability = VtValue();
  context->custom = false;
}
| prim_attr_qualifiers prim_attr_type { context->custom = false; };

prim_attribute_default : prim_attribute_full_type namespaced_name {
...
attribute_metadata_list_opt { context->path = context->path.GetParentPath(); };

prim_attribute_fallback : TOK_CUSTOM prim_attribute_full_type namespaced_name {
  context->custom = true;
...
time_samples_rhs {
  _SetField(context->path, SdfFieldKeys->TimeSamples, context->timeSamples,
            context);
  context->path = context->path.GetParentPath(); // pop attr
};

prim_attribute : prim_attribute_fallback | prim_attribute_default |
                 prim_attribute_connect | prim_attribute_time_samples;

//--------------------------------------------------------------------
// Attribute connections
//--------------------------------------------------------------------

connect_rhs : TOK_NONE | connect_item | '[' newlines_opt ']' |
              '[' newlines_opt connect_list listsep_opt ']';

connect_list : connect_item | connect_list listsep connect_item;

connect_item : prim_or_property_scene_path {
...
time_samples_rhs : '{' { context->timeSamples = SdfTimeSampleMap(); }
...
time_sample_list_int : time_sample | time_sample_list_int listsep time_sample;

time_sample : extended_number ':' {
...
attribute_metadata_list : attribute_metadata |
                          attribute_metadata_list stmtsep attribute_metadata;

attribute_metadata_key : identifier | TOK_CUSTOMDATA | TOK_SYMMETRYARGUMENTS;

attribute_metadata : TOK_STRING {
  _SetField(context->path, SdfFieldKeys->Comment, $1.Get<std::string>(),
            context);
}
...
'=' metadata_value { _GenericMetadataEnd(SdfSpecTypeAttribute, context); }
// Handling for generic metadata fields that use list ops.
// Note that handling of the 'explicit' list op type is done
// in the generic metadata clause above, since there is no
// marker that the parser can use to recognize that case.
...
'=' metadata_listop_list { _GenericMetadataEnd(SdfSpecTypeAttribute, context); }
| TOK_ADD identifier {
  _GenericMetadataStart($2, SdfSpecTypeAttribute, context);
  context->listOpType = SdfListOpTypeAdded;
}
...
| TOK_DISPLAYUNIT '=' identifier {
  _SetField(context->path, SdfFieldKeys->DisplayUnit,
            _GetDisplayUnitFromString($3.Get<std::string>(), context), context);
}
// Not parsed with generic metadata because: allows assignment to an empty
// string by omitting the value
| TOK_SYMMETRYFUNCTION '=' identifier {
...
attribute_value : typed_value {
  _SetField(context->path, SdfFieldKeys->Default, context->currentValue,
            context);
}
| TOK_NONE {
...
typed_dictionary : '{' { _DictionaryBegin(context); }
newlines_opt typed_dictionary_list_opt '}' { _DictionaryEnd(context); };
...
typed_dictionary_list : typed_dictionary_element |
...
string_dictionary : '{' { _DictionaryBegin(context); }
newlines_opt string_dictionary_list_opt '}' { _DictionaryEnd(context); };
...
string_dictionary_element : TOK_STRING ':' TOK_STRING {
...
typed_value : typed_value_atomic { _ValueSetAtomic(context); }
| typed_value_tuple { _ValueSetTuple(context); }
| typed_value_list { _ValueSetList(context); }
| '[' ']' {
...
| TOK_PATHREF { _ValueSetCurrentToSdfPath($1, context); };

typed_value_atomic : TOK_NUMBER { _ValueAppendAtomic($1, context); }
| TOK_STRING { _ValueAppendAtomic($1, context); }
| identifier {
...
typed_value_list : '[' { context->values.BeginList(); }
typed_value_list_int ']' { context->values.EndList(); };

typed_value_list_int : newlines_opt typed_value_list_items listsep_opt;

typed_value_list_items : typed_value_list_item |
                         typed_value_list_items listsep typed_value_list_item;

typed_value_list_item : typed_value_atomic | typed_value_list |
                        typed_value_tuple;
...
typed_value_tuple : '(' { context->values.BeginTuple(); }
typed_value_tuple_int ')' { context->values.EndTuple(); };

typed_value_tuple_int : newlines_opt typed_value_tuple_items listsep_opt;
...
prim_relationship_type : TOK_REL {
  context->custom = false;
  context->variability = VtValue(SdfVariabilityUniform);
}
| TOK_CUSTOM TOK_REL {
...
prim_relationship : prim_relationship_type namespaced_name {
  _PrimInitRelationship($2, context);
  context->relParsingAllowTargetData = true;
}
relationship_assignment_opt relationship_metadata_list_opt {
...
| prim_relationship_time_samples | prim_relationship_default;
...
relationship_metadata_key : identifier | TOK_CUSTOMDATA | TOK_SYMMETRYARGUMENTS;

relationship_metadata : TOK_STRING {
  _SetField(context->path, SdfFieldKeys->Comment, $1.Get<std::string>(),
            context);
}
...
'=' metadata_value { _GenericMetadataEnd(SdfSpecTypeRelationship, context); }
// Handling for generic metadata fields that use list ops.
// Note that handling of the 'explicit' list op type is done
// in the generic metadata clause above, since there is no
// marker that the parser can use to recognize that case.
...
relationship_rhs : relationship_target | TOK_NONE {
  context->relParsingTargetPaths = SdfPathVector();
}
| '[' newlines_opt ']' { context->relParsingTargetPaths = SdfPathVector(); }
...
relationship_target : TOK_PATHREF {
...
prim_path : TOK_PATHREF { _PathSetPrim($1, context); };

prim_or_property_scene_path : TOK_PATHREF {
...
namespaced_name : TOK_IDENTIFIER | TOK_NAMESPACED_IDENTIFIER | keyword;

// A generic name including C++ namespaced names but not keywords.
identifier : TOK_IDENTIFIER | TOK_CXX_NAMESPACED_IDENTIFIER;

// A number, inf, -inf or nan, all as double.
extended_number : TOK_NUMBER | TOK_IDENTIFIER { $$ = $1; };
...
stmtsep : ';' newlines_opt | newlines;

listsep_opt : newlines_opt | listsep;

listsep : ',' newlines_opt;
...
newlines : TOK_NL | newlines TOK_NL;
...
% %
    ...
    //--------------------------------------------------------------------
    void textFileFormatYyerror(Sdf_TextParserContext *context,
                               const char *msg) {
  ...
  std::string s = TfStringPrintf(
      "%s%s in <%s> on line %i", msg,
      isNewlineToken ? ""
                     : TfStringPrintf(" at \'%s\'", nextToken.c_str()).c_str(),
      context->path.GetText(), errLineNumber);
...
bool Sdf_ParseLayer(const std::string &fileContext,
                    ...
                    const std::string &versionString, bool metadataOnly,
                    SdfDataRefPtr data, SdfLayerHints *hints) {
...
bool Sdf_ParseLayerFromString(const std::string &layerString,
  ...
  // Run parser.
  yy_buffer_state *buf =
      textFileFormatYy_scan_string(layerString.c_str(), context.scanner);
  int status = -1;
  try {
    TRACE_SCOPE("textFileFormatYyParse");
    status = textFileFormatYyparse(&context);
