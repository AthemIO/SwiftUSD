...
struct QuotedStringChars
    : internal::plus<
        internal::sor<
            ...
            // by different rules.
            internal::seq<
                internal::not_at<internal::sor<VariableStart, one<QuoteChar>>>, 
                any
            >
        >
    >
...
struct FunctionArguments
    : internal::sor<
        internal::list_tail_pad<FunctionArgument, one<','>, one<' '>>,
        internal::star<one<' '>>
    >
{};
...
struct Function
    : internal::if_must< false,
        internal::seq<FunctionName, FunctionArgumentStart>,
        FunctionArguments,
        FunctionArgumentEnd
    >
{};
...
struct ListElements
    : internal::sor<
        internal::list_tail_pad<ListElement, one<','>, one<' '>>,
        internal::star<one<' '>>
    >
{};
